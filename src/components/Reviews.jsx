    ...
    <div className="relative py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative bg-white shadow-xl rounded-lg p-8 max-w-3xl mx-auto">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-teal-500 text-white w-10 h-10 rounded-full flex items-center justify-center shadow-lg hover:bg-teal-600 transition"
          >
            &#8592;
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-teal-500 text-white w-10 h-10 rounded-full flex items-center justify-center shadow-lg hover:bg-teal-600 transition"
          >
            &#8594;
          </button>
        </div>
