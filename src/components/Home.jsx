    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
        <div className="text-left md:order-1">
          <p className="text-teal-700 uppercase tracking-wider text-sm mb-2">
          ...
          <a 
            href="#contact" 
            className="flex items-center w-fit gap-3 bg-teal-700 text-white px-6 py-3 rounded-full uppercase hover:bg-teal-800 transition-colors"
          >
